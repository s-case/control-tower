(function(){
  ...
  //controller to get the data from the S-CASE artefacts repo
  ...
  */
  ...
  //controloller to perform the search
  app.controller('SearchController',function(){

    this.domains=domains;
    this.subdomains=subdomains;
    this.requirementsClass={};
    this.operations={};

    this.doSearch = function(searchQuery){
      searchQuery.requirementsClass = this.requirementsClass;
      searchQuery.operations=this.operations;
      searchQuery.domainsQuery=this.domains;
      searchQuery.subdomainsQuery=this.subdomains;
      
      this.domains=domains;
      this.subdomains=subdomains;
      this.requirementsClass={};
      this.operations={};
      //function to call the service to perform the search to S-CASE artefacts repo
    };
  });
  var domains= // call to get all the domains from the S-CASE artefacts repo
  var subdomains = // call to get all the subdomains from the S-CASE artefacts repo
